...
extern json_spirit::Value lookupvanikey(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value sendtovanikey(const json_spirit::Array& params, bool fHelp);
